...
# Как используются витрины
 ...
 2. 
 3. Результат запроса экспортируется в CSV.
 4. 
 5. CSV используется в BI-инструменте (Yandex DataLens) для построения дашбордов.
...
/sql/dm      → факты и измерения (звезда)
